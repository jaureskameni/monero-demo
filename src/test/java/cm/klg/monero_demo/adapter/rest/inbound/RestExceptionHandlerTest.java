...
@ContextConfiguration(
    classes = {RestExceptionHandler.class, RestExceptionHandlerTest.TestController.class})
class RestExceptionHandlerTest {
  ...
  @MockBean private CryptoWalletAddressController cryptoWalletAddressController;
  ...
  void whenMoneroRpcException_thenReturns503() throws Exception {
    mockMvc
        .perform(get("/test/rpc-error").contentType(MediaType.APPLICATION_JSON))
  ...
  void whenResourceAlreadyExistsException_thenReturns409() throws Exception {
    mockMvc
        .perform(get("/test/conflict-error").contentType(MediaType.APPLICATION_JSON))
